          ...
          >
            ...
            <div className="mb-3">
              <Slider
                ...
                className="cursor-pointer [&_[role=slider]]:h-3 [&_[role=slider]]:w-3 [&_[role=slider]]:bg-primary [&_.range]:bg-primary"
              />
            </div>
                ...
                <div className="flex items-center gap-2 group/volume">
                  ...
                  <div className="w-0 overflow-hidden group-hover/volume:w-20 transition-all duration-300">
                    <Slider
                      ...
                      className="cursor-pointer [&_[role=slider]]:h-3 [&_[role=slider]]:w-3 [&_[role=slider]]:bg-white [&_.range]:bg-white"
                    />
                  </div>
                </div>
